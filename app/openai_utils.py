...
def create_biller_prompt(patient_notes):
    # Prompt components
    persona = (
    ...
    data = f"Text to recommend CPT From: {patient_notes}"
...
def summarize_patient_notes(system_prompt, user_prompt):
...
# Function call to generate the Summary Notes 
def generate_summary_notes(patient_notes):
    # Get the system and user prompts
    system_prompt, user_prompt = create_prompt(patient_notes)
    return summarize_patient_notes(system_prompt, user_prompt)

# Function call to generate CPT Codes
def generate_CPT_Codes(patient_notes):
    # Get the system and user prompts
    system_prompt, user_prompt = create_biller_prompt(patient_notes)
    return summarize_patient_notes(patient_notes, system_prompt, user_prompt)
...
# summary = generate_summary_notes(text)
# #print(summary)
...
# Call the CPT II Code Generation Function
