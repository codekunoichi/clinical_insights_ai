...
class ModelOrchestrator:
    def __init__(self, model_type: str, prompter_type: str):
        ...
        elif prompter_type == 'clinical_decision_support':
            self.prompter = ClinicalDecisionSupportPrompter()
        else:
